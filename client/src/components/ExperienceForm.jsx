                        ...
                        <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                            ...
                            <div className='space-y-2'>
                                <div className='flex items-center justify-between'>
                                    ...
                                    <button
                                        onClick={() => genrateDescription(index)}
                                        disabled={
                                            generatingIndex === index ||
                                            !experience.position ||
                                            !experience.company
                                        }
                                        className="flex items-center justify-center gap-1 px-2 py-1 text-xs bg-purple-200 text-purple-700 rounded hover:bg-purple-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
                                        {generatingIndex === index ? (
                                ...
                                <textarea value={experience.description || ""} onChange={(e) => UpdateExperience(index, "description", e.target.value)} className='w-full text-sm px-3 py-2 rounded-lg resize-none' placeholder='Describe your key responsiblities and achievements....' />
                            </div>
                        </div>
                    ))}
                </div>
